"""Integration wrapper — the main entry point for external callers."""
...
from ..wrapper.shadow import build_shadow_result, ShadowResult
from dataclasses import asdict


class DecisionEngineWrapper:
    """Top-level integration wrapper. Accepts legacy payloads, returns backward-compatible responses."""
    ...
    def evaluate_explore(self, payload: LegacyExplorePayload, v2_action: str | None = None, v2_intent: float = 0.0, v2_viability: float = 0.0) -> dict:
        ...
        response = decision_to_legacy_response(decision)
